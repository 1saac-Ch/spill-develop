...
const WriteDiscussion = () => {
  return (
    <div className="w-full space-y-10 md:space-y-3">
      <form className="space-y-3">
        ...
        <div className="relative rounded-xl h-[104px] border md:px-4 md:py-3">
          <textarea
            id="new-review"
            className="w-full p-4 resize-none h-full placeholder:text-abu text-label-lg placeholder:text-label-lg font-satoshi placeholder:font-satoshi"
